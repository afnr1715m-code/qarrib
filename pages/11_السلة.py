...
from ui_helpers import apply_rtl, category_label, render_customer_bottom_nav, render_language_switcher, render_page_title, t, format_price
...
render_customer_bottom_nav(active="cart")
